...
* A fairly recent installation of Node - I use v18.12.1

Steps:

1. Copy `.env.local-sample` to `.env.local` and fill in `BUNGIE_API_KEY`, `BUNGIE_OAUTH_CLIENT_ID` and `BUNGIE_OAUTH_CLIENT_SECRET` and with the values from your Bungie.net application (see below for instructions)
